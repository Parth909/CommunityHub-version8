...
module.exports = {
  ...
  async postRegister(req, res, next) {
    try {
        ...
        //for image
			if (req.files.profimage[0]) { //If file exists (file will not be in the req.body as for uploading we use multipart form-data)
  ...
  async putReset(req, res, next) {
	...
	getOptionsPage(req, res, next) {
		res.render('index/options');
	},

	getAdvOptionsPage(req, res, next) {
		res.render('index/advoptions');
	},

	//ALWAYS AT THE LAST
	getDefaultPage(req, res, next) {
