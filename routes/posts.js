...
// upload.single('image'),
router.post('/', isLoggedIn, upload.array('postImages', 4), asyncErrorHandler(postCreate));
...
router.put('/:id/:type', isLoggedIn, asyncErrorHandler(isAuthor), upload.array('images', 4), asyncErrorHandler(postUpdate));
